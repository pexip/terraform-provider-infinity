		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ca_certificate.ca_certificate-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_ca_certificate.ca_certificate-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ca_certificate.ca_certificate-test", "trusted_intermediate", "false"),
					resource.TestCheckResourceAttr("infinity_ca_certificate.ca_certificate-test", "subject_name", "Test CA"),
					resource.TestCheckResourceAttr("infinity_ca_certificate.ca_certificate-test", "issuer_name", "Test CA"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_ca_certificate.ca_certificate-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ca_certificate.ca_certificate-test", "trusted_intermediate", "false"),
					resource.TestCheckResourceAttr("infinity_ca_certificate.ca_certificate-test", "subject_name", "Updated CA"),
					resource.TestCheckResourceAttr("infinity_ca_certificate.ca_certificate-test", "issuer_name", "Updated CA"),
				),
			},
		},
	})
