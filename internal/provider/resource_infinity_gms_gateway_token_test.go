		...
		Steps: []resource.TestStep{
			// Step 1: Create with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_gms_gateway_token.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_gms_gateway_token.test", "certificate"),
					resource.TestCheckResourceAttrSet("infinity_gms_gateway_token.test", "private_key"),
					resource.TestCheckResourceAttrSet("infinity_gms_gateway_token.test", "intermediate_certificate"),
					resource.TestCheckResourceAttrSet("infinity_gms_gateway_token.test", "leaf_certificate"),
					resource.TestCheckResourceAttrSet("infinity_gms_gateway_token.test", "supports_direct_guest_join"),
				),
			},
