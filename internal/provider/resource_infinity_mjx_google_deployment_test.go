		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_google_deployment.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_google_deployment.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "name", "tf-test mjx-google-deployment full"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "description", "Test MJX Google deployment description"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "client_email", "test-service@my-project.iam.gserviceaccount.com"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "client_id", "123456789012345678901"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "client_secret", "test-client-secret"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "private_key", "test-private-key"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "use_user_consent", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "auth_endpoint", "https://accounts.google.com/o/oauth2/v2/auth"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "token_endpoint", "https://oauth2.googleapis.com/token"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "redirect_uri", "https://pexip.example.com/admin/platform/mjxgoogledeployment/oauth_redirect/"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "maximum_number_of_api_requests", "500000"),
				),
			},
			// Step 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_google_deployment.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_google_deployment.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "name", "tf-test mjx-google-deployment min"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "client_email", "test-service@my-project.iam.gserviceaccount.com"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "private_key", "test-private-key"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "use_user_consent", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "auth_endpoint", "https://accounts.google.com/o/oauth2/v2/auth"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "token_endpoint", "https://oauth2.googleapis.com/token"),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "redirect_uri", ""),
					resource.TestCheckResourceAttr("infinity_mjx_google_deployment.test", "maximum_number_of_api_requests", "900000"),
				),
			},
			// Step 3: Destroy
			{
