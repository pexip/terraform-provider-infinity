		...
		Steps: []resource.TestStep{
			// Test 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_device.tf-test-device", "id"),
					resource.TestCheckResourceAttrSet("infinity_device.tf-test-device", "resource_id"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "alias", "tf-test-device"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "description", "Test Device Description"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "username", "tf-test-user"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "password", "tf-test-pass"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "primary_owner_email_address", "tf-test@example.com"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "enable_sip", "true"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "enable_h323", "true"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "enable_infinity_connect_non_sso", "true"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "enable_infinity_connect_sso", "true"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "enable_standard_sso", "true"),
					resource.TestCheckResourceAttrSet("infinity_device.tf-test-device", "sso_identity_provider_group"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "tag", "tf-test-tag"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "sync_tag", "tf-test-sync-tag"),
				),
			},
			// Test 2: Update to min config (then delete)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_device.tf-test-device", "resource_id"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "alias", "tf-test-device"),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "username", ""),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "password", ""),
					resource.TestCheckResourceAttr("infinity_device.tf-test-device", "description", ""),
				),
			},
		},
	})
