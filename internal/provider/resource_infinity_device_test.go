		...
		Steps: []resource.TestStep{
			...
			// Test 2: Update to min config (then delete)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("pexip_infinity_device.tf-test-device", "resource_id"),
					resource.TestCheckResourceAttr("pexip_infinity_device.tf-test-device", "alias", "tf-test-device"),
					resource.TestCheckResourceAttr("pexip_infinity_device.tf-test-device", "username", ""),
					resource.TestCheckResourceAttr("pexip_infinity_device.tf-test-device", "password", ""),
					resource.TestCheckResourceAttr("pexip_infinity_device.tf-test-device", "description", ""),
				),
			},
		},
	})
