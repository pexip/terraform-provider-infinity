		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_meeting_processing_rule.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_meeting_processing_rule.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "name", "tf-test mjx-meeting-processing-rule full"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "description", "Test MJX meeting processing rule"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "priority", "10"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "enabled", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "meeting_type", "teams"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "mjx_integration", "/api/admin/configuration/v1/mjx_integration/1/"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "transform_rule", "{{ domain }}"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "domain", "example.com"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "company_id", "test-company-id"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "include_pin", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "default_processing_enabled", "false"),
				),
			},
			// Step 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_meeting_processing_rule.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_meeting_processing_rule.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "name", "tf-test mjx-meeting-processing-rule min"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "priority", "1"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "enabled", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "meeting_type", "pexipinfinity"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "mjx_integration", "/api/admin/configuration/v1/mjx_integration/1/"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "match_string", ""),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "replace_string", ""),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "domain", ""),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "company_id", ""),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "include_pin", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_meeting_processing_rule.test", "default_processing_enabled", "true"),
				),
			},
			// Step 3: Destroy
			{
