		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_media_library_playlist_entry.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_media_library_playlist_entry.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "entry_type", "MEDIA"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "media", "/api/admin/configuration/v1/media_library_entry/1/"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "playlist", "/api/admin/configuration/v1/media_library_playlist/2/"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "position", "5"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "playcount", "3"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "entry_type", "MEDIA"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "playlist", "/api/admin/configuration/v1/media_library_playlist/2/"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "position", "1"),
					resource.TestCheckResourceAttr("infinity_media_library_playlist_entry.test", "playcount", "1"),
				),
			},
			{
				// Step 3: Destroy
