		...
		Steps: []resource.TestStep{
			// Test 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_field.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_field.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "name", "tf-test-full"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "template_variable_name", "testfull"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "is_binary", "true"),
				),
			},
			// Test 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_field.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_field.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "name", "tf-test-min"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "template_variable_name", "testmin"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_ldap_sync_field.test", "is_binary", "false"),
				),
			},
