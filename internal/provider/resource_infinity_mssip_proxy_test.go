		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mssip_proxy.tf-test-mssip-proxy", "id"),
					resource.TestCheckResourceAttrSet("infinity_mssip_proxy.tf-test-mssip-proxy", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "name", "tf-test-mssip-proxy"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "description", "tf-test MSSIP Proxy Description"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "address", "mssip-proxy.example.com"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "port", "5060"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "transport", "tcp"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_mssip_proxy.tf-test-mssip-proxy", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "name", "tf-test-mssip-proxy"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "description", ""),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "address", "mssip-proxy-min.example.com"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "port", "5061"),
					resource.TestCheckResourceAttr("infinity_mssip_proxy.tf-test-mssip-proxy", "transport", "tls"),
				),
			},
			{
				// Step 3: Destroy
