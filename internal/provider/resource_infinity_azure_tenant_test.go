		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_azure_tenant.azure_tenant-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_azure_tenant.azure_tenant-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_azure_tenant.azure_tenant-test", "name", "tf-test-azure-tenant-full"),
					resource.TestCheckResourceAttr("infinity_azure_tenant.azure_tenant-test", "description", "Test AzureTenant tf-test full"),
					resource.TestCheckResourceAttr("infinity_azure_tenant.azure_tenant-test", "tenant_id", "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_azure_tenant.azure_tenant-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_azure_tenant.azure_tenant-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_azure_tenant.azure_tenant-test", "name", "tf-test-azure-tenant-min"),
					resource.TestCheckResourceAttr("infinity_azure_tenant.azure_tenant-test", "description", ""),
					resource.TestCheckResourceAttr("infinity_azure_tenant.azure_tenant-test", "tenant_id", "87654321-4321-4321-4321-210987654321"),
				),
			},
			{
				Config:  test.LoadTestFolder(t, "resource_infinity_azure_tenant_min"),
