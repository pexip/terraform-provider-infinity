		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_mjx_exchange_autodiscover_url.test", "name", "tf-test mjx-exchange-autodiscover-url full"),
					resource.TestCheckResourceAttr("infinity_mjx_exchange_autodiscover_url.test", "description", "Test Exchange Autodiscover URL description"),
					resource.TestCheckResourceAttr("infinity_mjx_exchange_autodiscover_url.test", "url", "https://autodiscover-full.example.com/autodiscover/autodiscover.xml"),
					resource.TestCheckResourceAttr("infinity_mjx_exchange_autodiscover_url.test", "exchange_deployment", "/api/admin/configuration/v1/mjx_exchange_deployment/2/"),
				),
			},
			// Step 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_mjx_exchange_autodiscover_url.test", "exchange_deployment", "/api/admin/configuration/v1/mjx_exchange_deployment/1/"),
				),
			},
			// Step 3: Destroy
			{
