		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_oauth2_client.oauth2_client-test", "id"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "resource_id", "123"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "client_id", "test-oauth2-client-id"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "client_name", "tf-test oauth2_client RW"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "role", "/api/admin/configuration/v1/role/1/"),
					resource.TestCheckResourceAttrSet("infinity_oauth2_client.oauth2_client-test", "private_key_jwt"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "resource_id", "123"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "client_id", "test-oauth2-client-id"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "client_name", "tf-test oauth2_client RO"),
					resource.TestCheckResourceAttr("infinity_oauth2_client.oauth2_client-test", "role", "/api/admin/configuration/v1/role/2/"),
					resource.TestCheckResourceAttrSet("infinity_oauth2_client.oauth2_client-test", "private_key_jwt"),
				),
			},
		},
