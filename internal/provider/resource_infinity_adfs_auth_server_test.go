		...
		Steps: []resource.TestStep{
			// Test 1: Create with full configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_adfs_auth_server.tf-test-adfs-auth-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_adfs_auth_server.tf-test-adfs-auth-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "name", "tf-test-adfs-auth-server"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "description", "Full test configuration for ADFS Auth Server"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "client_id", "test-client-id-full"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "federation_service_name", "adfs-full.example.com"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "federation_service_identifier", "https://adfs-full.example.com/adfs/services/trust"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "relying_party_trust_identifier_url", "https://full.example.com"),
				),
			},
			// Test 2: Update to min configuration, then delete
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "name", "tf-test-adfs-auth-server"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "description", "Full test configuration for ADFS Auth Server"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "client_id", "test-client-id-min"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "federation_service_name", "adfs-min.example.com"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "federation_service_identifier", "https://adfs-min.example.com/adfs/services/trust"),
					resource.TestCheckResourceAttr("infinity_adfs_auth_server.tf-test-adfs-auth-server", "relying_party_trust_identifier_url", "https://min.example.com"),
				),
			},
