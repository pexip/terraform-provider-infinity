		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "name", "tf-test-teams-proxy-full"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "description", "Test Teams Proxy Full Configuration"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "address", "teams-proxy-full.pexvclab.com"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "port", "8443"),
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "azure_tenant"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "min_number_of_instances", "3"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "notifications_enabled", "true"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "notifications_queue", "Endpoint=sb://examplevmss.servicebus.windows.net/;SharedAccessKeyName=standard_access_policy;SharedAccessKey=testkey123="),
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "eventhub_id"), // Computed by API
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "name", "tf-test-teams-proxy-min"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "description", ""),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "address", "teams-proxy-min.pexvclab.com"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "port", "443"),
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "azure_tenant"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "min_number_of_instances", "1"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "notifications_enabled", "false"),
					resource.TestCheckResourceAttr("infinity_teams_proxy.teams-proxy-test", "notifications_queue", ""),
					resource.TestCheckResourceAttrSet("infinity_teams_proxy.teams-proxy-test", "eventhub_id"), // Persists from previous config
				),
			},
			{
				Config:  test.LoadTestFolder(t, "resource_infinity_teams_proxy_min"),
