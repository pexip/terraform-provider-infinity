		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_snmp_network_management_system.tf-test-snmp-nms", "id"),
					resource.TestCheckResourceAttrSet("infinity_snmp_network_management_system.tf-test-snmp-nms", "resource_id"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "name", "tf-test-snmp-nms"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "description", "tf-test SNMP NMS Description"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "address", "192.168.1.100"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "port", "162"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "snmp_trap_community", "tf-test-comm"),
				),
			},
			// Step 2: Update to min config (clearing optional fields)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_snmp_network_management_system.tf-test-snmp-nms", "resource_id"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "name", "tf-test-snmp-nms"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "description", ""),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "address", "192.168.1.100"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "port", "161"),
					resource.TestCheckResourceAttr("infinity_snmp_network_management_system.tf-test-snmp-nms", "snmp_trap_community", "public"),
				),
			},
			// Step 3: Destroy
			{
