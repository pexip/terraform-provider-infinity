		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "id"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "resource_id"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "name", "tf-test-system-location-full"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "description", "Full configuration test location"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "mtu", "1460"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "media_qos", "46"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "signalling_qos", "24"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "local_mssip_domain", "test-mssip.pexvclab.com"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "bdpm_pin_checks_enabled", "ON"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "bdpm_scan_quarantine_enabled", "ON"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "use_relay_candidates_only", "true"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "dns_servers.#", "2"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "ntp_servers.#", "1"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "client_stun_servers.#", "2"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "client_turn_servers.#", "2"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "event_sinks.#", "1"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "syslog_servers.#", "0"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "h323_gatekeeper"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "http_proxy"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "mssip_proxy"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "policy_server"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "sip_proxy"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "snmp_network_management_system"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "stun_server"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "teams_proxy"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "turn_server"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "overflow_location1"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "overflow_location2"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "transcoding_location"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "live_captions_dial_out_1"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "live_captions_dial_out_2"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "live_captions_dial_out_3"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "id"),
					resource.TestCheckResourceAttrSet("infinity_system_location.main-location", "resource_id"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "name", "tf-test-system-location-min"),

					// Optional fields cleared - verify defaults
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "description", ""),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "mtu", "1500"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "media_qos", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "signalling_qos", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "local_mssip_domain", ""),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "bdpm_pin_checks_enabled", "GLOBAL"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "bdpm_scan_quarantine_enabled", "GLOBAL"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "use_relay_candidates_only", "false"),

					// Collections cleared
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "dns_servers.#", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "ntp_servers.#", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "client_stun_servers.#", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "client_turn_servers.#", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "event_sinks.#", "0"),
					resource.TestCheckResourceAttr("infinity_system_location.main-location", "syslog_servers.#", "0"),

					// Nullable fields cleared via UPDATE - should be null
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "h323_gatekeeper"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "http_proxy"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "mssip_proxy"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "policy_server"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "sip_proxy"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "snmp_network_management_system"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "stun_server"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "teams_proxy"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "turn_server"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "overflow_location1"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "overflow_location2"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "transcoding_location"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "live_captions_dial_out_1"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "live_captions_dial_out_2"),
					resource.TestCheckNoResourceAttr("infinity_system_location.main-location", "live_captions_dial_out_3"),
				),
			},
			{
