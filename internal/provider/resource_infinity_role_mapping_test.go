		...
		Steps: []resource.TestStep{
			// Test 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_role_mapping.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_role_mapping.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "name", "tf-test role mapping full"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "source", "OIDC"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "value", "testfull"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "roles.#", "2"),
					resource.TestCheckTypeSetElemAttrPair("infinity_role_mapping.test", "roles.*", "infinity_role.test1", "id"),
					resource.TestCheckTypeSetElemAttrPair("infinity_role_mapping.test", "roles.*", "infinity_role.test2", "id"),
				),
			},
			// Test 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_role_mapping.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_role_mapping.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "name", "tf-test role mapping min"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "source", "LDAP"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "value", "testmin"),
					resource.TestCheckResourceAttr("infinity_role_mapping.test", "roles.#", "0"),
				),
			},
