		...
		Steps: []resource.TestStep{
			// Test 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_automatic_participant.automatic-participant-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_automatic_participant.automatic-participant-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "alias", "tf-test-adp"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "description", "Test AutomaticParticipant Full Config"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "protocol", "h323"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "call_type", "audio"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "role", "chair"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "dtmf_sequence", "456*"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "keep_conference_alive", "keep_conference_alive"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "routing", "routing_rule"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "streaming", "true"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "remote_display_name", "tf-test-adp-display"),
					resource.TestCheckResourceAttr("infinity_automatic_participant.automatic-participant-test", "presentation_url", "https://example.com/presentation"),
				),
			},
