		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_worker_vm.worker-vm-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_worker_vm.worker-vm-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "name", "tf-test-full_worker-vm"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "hostname", "worker-vm-test"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "domain", "test-value"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "address", "192.168.1.10"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "netmask", "255.255.255.0"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "gateway", "192.168.1.1"),
					resource.TestCheckResourceAttrPair(
						"infinity_worker_vm.worker-vm-test", "system_location",
						"infinity_system_location.test", "id",
					),
					resource.TestCheckResourceAttrPair(
						"infinity_worker_vm.worker-vm-test", "tls_certificate",
						"infinity_tls_certificate.test", "id",
					),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "alternative_fqdn", "alt.example.com"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "ipv6_address", "2001:db8::1"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "ipv6_gateway", "2001:db8::fe"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "description", "initial description"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "transcoding", "true"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "maintenance_mode", "true"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "maintenance_mode_reason", "test-value"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "vm_cpu_count", "4"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "vm_system_memory", "4096"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "secondary_address", "172.16.0.10"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "secondary_netmask", "255.255.255.0"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "media_priority_weight", "10"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "static_nat_address", "203.0.113.2"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_system_location", "test-value"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_authentication_password", "auth-password1"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_community", "public1"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_mode", "STANDARD"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_privacy_password", "privacy-password1"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_system_contact", "snmpcontact1@domain.com"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_username", "snmp-user1"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "enable_ssh", "ON"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "password", "password-initial"),
					resource.TestCheckTypeSetElemAttrPair("infinity_worker_vm.worker-vm-test", "ssh_authorized_keys.*", "infinity_ssh_authorized_key.test", "id"),
					resource.TestCheckTypeSetElemAttrPair("infinity_worker_vm.worker-vm-test", "static_routes.*", "infinity_static_route.test", "id"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_worker_vm.worker-vm-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_worker_vm.worker-vm-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "name", "tf-test-min_worker-vm"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "hostname", "worker-vm-test"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "domain", "test-value"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "address", "192.168.1.10"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "netmask", "255.255.255.0"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "gateway", "192.168.1.1"),
					resource.TestCheckResourceAttrSet("infinity_worker_vm.worker-vm-test", "system_location"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "password", "password-initial"),
					...
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "alternative_fqdn", ""),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "description", ""),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "maintenance_mode", "false"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "maintenance_mode_reason", ""),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "node_type", "CONFERENCING"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "deployment_type", "MANUAL-PROVISION-ONLY"),
					resource.TestCheckResourceAttrSet("infinity_worker_vm.worker-vm-test", "transcoding"), // Computed only, just verify it exists
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "enable_ssh", "GLOBAL"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_mode", "DISABLED"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_system_contact", "admin@domain.com"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_system_location", "Virtual machine"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_community", "public"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_authentication_password", ""),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_privacy_password", ""),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "snmp_username", ""),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "vm_cpu_count", "4"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "vm_system_memory", "4096"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "enable_distributed_database", "true"),
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "ssh_authorized_keys_use_cloud", "true"),

					// Fields with defaults that should be reset to default when cleared
					resource.TestCheckResourceAttr("infinity_worker_vm.worker-vm-test", "media_priority_weight", "0"),

					// Nullable fields cleared via UPDATE - API should return null
					resource.TestCheckNoResourceAttr("infinity_worker_vm.worker-vm-test", "tls_certificate"),
					resource.TestCheckNoResourceAttr("infinity_worker_vm.worker-vm-test", "secondary_address"),
					resource.TestCheckNoResourceAttr("infinity_worker_vm.worker-vm-test", "secondary_netmask"),
					resource.TestCheckNoResourceAttr("infinity_worker_vm.worker-vm-test", "static_nat_address"),
				),
			},
			{
