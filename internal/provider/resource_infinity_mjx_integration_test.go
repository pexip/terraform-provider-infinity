		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_integration.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_integration.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "name", "tf-test mjx-integration full"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "description", "Test MJX integration description"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "display_upcoming_meetings", "14"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "enable_non_video_meetings", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "enable_private_meetings", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "end_buffer", "10"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "start_buffer", "10"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_username", "ep-user@example.com"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_password", "ep-password-test"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_use_https", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_verify_certificate", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "graph_deployment", "/api/admin/configuration/v1/mjx_graph_deployment/2/"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "process_alias_private_meetings", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "replace_empty_subject", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "replace_subject_type", "ALL"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "replace_subject_template", "Meeting: {{ subject }}"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "use_webex", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "webex_api_domain", "custom.webexapis.com"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "webex_client_id", "webex-client-id-full"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "webex_client_secret", "webex-secret-full"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "webex_redirect_uri", "https://pexip.example.com/admin/platform/mjxintegration/oauth_redirect/"),
				),
			},
			// Step 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_integration.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_integration.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "name", "tf-test mjx-integration min"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "display_upcoming_meetings", "7"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "enable_non_video_meetings", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "enable_private_meetings", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "end_buffer", "0"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "start_buffer", "5"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_username", ""),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_use_https", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "ep_verify_certificate", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "graph_deployment", "/api/admin/configuration/v1/mjx_graph_deployment/1/"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "process_alias_private_meetings", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "replace_empty_subject", "true"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "replace_subject_type", "PRIVATE"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "replace_subject_template", ""),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "use_webex", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_integration.test", "webex_api_domain", "webexapis.com"),
				),
			},
			// Step 3: Destroy
			{
