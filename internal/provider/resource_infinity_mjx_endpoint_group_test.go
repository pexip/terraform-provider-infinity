		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint_group.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint_group.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "name", "tf-test mjx-endpoint-integration-group full"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "description", "Test MJX endpoint integration group"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "system_location", "/api/admin/configuration/v1/system_location/2/"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "mjx_integration", "/api/admin/configuration/v1/mjx_integration/1/"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "disable_proxy", "true"),
				),
			},
			// Step 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint_group.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint_group.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "name", "tf-test mjx-endpoint-integration-group min"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "system_location", "/api/admin/configuration/v1/system_location/1/"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint_group.test", "disable_proxy", "false"),
				),
			},
			// Step 3: Destroy
			{
