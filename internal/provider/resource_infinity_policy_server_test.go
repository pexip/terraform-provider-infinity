		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_policy_server.tf-test-policy-server", "url", "https://policy.example.com"),
					resource.TestCheckResourceAttr("infinity_policy_server.tf-test-policy-server", "username", "tf-test-user"),
					resource.TestCheckResourceAttr("infinity_policy_server.tf-test-policy-server", "password", "tf-test-password"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_policy_server.tf-test-policy-server", "password", ""),
