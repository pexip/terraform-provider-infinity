		...
		Steps: []resource.TestStep{
			// Step 1: Create with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ssh_authorized_key.tf-test-ssh-key", "id"),
					resource.TestCheckResourceAttrSet("infinity_ssh_authorized_key.tf-test-ssh-key", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ssh_authorized_key.tf-test-ssh-key", "keytype", "ssh-ed25519"),
					resource.TestCheckResourceAttr("infinity_ssh_authorized_key.tf-test-ssh-key", "key", "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKTj7PIu5ycIpVVxMYlnHmVKlhG4ALxqryNSfy59XIGf tf-test"),
					resource.TestCheckResourceAttr("infinity_ssh_authorized_key.tf-test-ssh-key", "comment", "tf-test"),
					resource.TestCheckResourceAttr("infinity_ssh_authorized_key.tf-test-ssh-key", "nodes.#", "0"),
				),
			},
