		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_scheduled_scaling.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_scheduled_scaling.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "policy_name", "tf-test scheduled scaling full"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "policy_type", "TeamsConnectorScaling"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "resource_identifier", "tf-test teams-proxy scheduled scaling"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "enabled", "false"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "local_timezone", "America/New_York"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "start_date", "2024-06-15"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "time_from", "08:30:00"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "time_to", "18:30:00"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "instances_to_add", "5"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "minutes_in_advance", "30"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "mon", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "tue", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "wed", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "thu", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "fri", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "sat", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "sun", "true"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_scheduled_scaling.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_scheduled_scaling.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "policy_name", "tf-test scheduled scaling min"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "policy_type", "TeamsConnectorScaling"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "resource_identifier", "tf-test teams-proxy scheduled scaling"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "enabled", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "local_timezone", "UTC"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "start_date", "2024-01-01"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "time_from", "09:00:00"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "time_to", "17:00:00"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "instances_to_add", "0"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "minutes_in_advance", "20"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "mon", "true"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "tue", "false"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "wed", "false"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "thu", "false"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "fri", "false"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "sat", "false"),
					resource.TestCheckResourceAttr("infinity_scheduled_scaling.test", "sun", "false"),
				),
			},
			{
