		...
		Steps: []resource.TestStep{
			// Step 1: Create with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_static_route.tf-test-static-route", "id"),
					resource.TestCheckResourceAttrSet("infinity_static_route.tf-test-static-route", "resource_id"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "name", "tf-test-static-route"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "address", "192.168.1.0"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "prefix", "24"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "gateway", "192.168.1.1"),
				),
			},
			// Step 2: Update to full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_static_route.tf-test-static-route", "id"),
					resource.TestCheckResourceAttrSet("infinity_static_route.tf-test-static-route", "resource_id"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "name", "tf-test-static-route-updated"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "address", "10.0.0.0"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "prefix", "16"),
					resource.TestCheckResourceAttr("infinity_static_route.tf-test-static-route", "gateway", "10.0.0.1"),
				),
			},
		},
	})
