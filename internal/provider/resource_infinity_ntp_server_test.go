		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ntp_server.tf-test-ntp", "id"),
					resource.TestCheckResourceAttrSet("infinity_ntp_server.tf-test-ntp", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ntp_server.tf-test-ntp", "address", "1.europe.pool.ntp.org"),
					resource.TestCheckResourceAttr("infinity_ntp_server.tf-test-ntp", "description", "tf-test NTP Server Description"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ntp_server.tf-test-ntp", "id"),
					resource.TestCheckResourceAttrSet("infinity_ntp_server.tf-test-ntp", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ntp_server.tf-test-ntp", "address", "0.europe.pool.ntp.org"),
					resource.TestCheckResourceAttr("infinity_ntp_server.tf-test-ntp", "description", ""),
				),
			},
			{
				// Step 3: Destroy
