		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_http_proxy.tf-test-http-proxy", "id"),
					resource.TestCheckResourceAttrSet("infinity_http_proxy.tf-test-http-proxy", "resource_id"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "name", "tf-test-http-proxy"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "address", "proxy.example.com"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "port", "8081"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "protocol", "http"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "username", "tf-test-user"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "password", "tf-test-password"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_http_proxy.tf-test-http-proxy", "resource_id"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "name", "tf-test-http-proxy"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "address", "proxy-min.example.com"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "port", "8080"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "protocol", "http"),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "username", ""),
					resource.TestCheckResourceAttr("infinity_http_proxy.tf-test-http-proxy", "password", ""),
				),
			},
			{
				// Step 3: Destroy
