		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_syslog_server.tf-test-syslog-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_syslog_server.tf-test-syslog-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "address", "syslog-full.example.com"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "description", "tf-test syslog server description"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "port", "1514"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "transport", "tls"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "audit_log", "true"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "support_log", "true"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "web_log", "true"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "proto_format", "rfc5424"),
				),
			},
			// Step 2: Update to min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_syslog_server.tf-test-syslog-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_syslog_server.tf-test-syslog-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "address", "syslog.example.com"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "description", ""),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "port", "514"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "transport", "udp"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "audit_log", "false"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "support_log", "false"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "web_log", "false"),
					resource.TestCheckResourceAttr("infinity_syslog_server.tf-test-syslog-server", "proto_format", "rfc3164"),
				),
			},
			// Step 3: Destroy
			{
