		...
		Steps: []resource.TestStep{
			// Test 1: Create with full configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "description", "Full test configuration for conference"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "service_type", "conference"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "pin", "123456"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "guest_pin", "654321"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "tag", "tf-test-tag"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "allow_guests", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "breakout_rooms", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "call_type", "video-only"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "crypto_mode", "besteffort"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "denoise_enabled", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "direct_media", "best_effort"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "direct_media_notification_duration", "5"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "enable_active_speaker_indication", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "enable_chat", "yes"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "enable_overlay_text", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "force_presenter_into_main", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "guests_can_present", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "guests_can_see_guests", "always"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "host_view", "two_mains_twentyone_pips"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "live_captions_enabled", "yes"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "match_string", "^[0-9]+$"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "max_callrate_in", "4096"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "max_callrate_out", "2048"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "max_pixels_per_second", "fullhd"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "mute_all_guests", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "non_idp_participants", "allow_if_trusted"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "on_completion", "{\"disconnect\": true}"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "participant_limit", "50"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "post_match_string", "^test"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "post_replace_string", "new-test"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "primary_owner_email_address", "owner@example.com"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "replace_string", "replaced"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "softmute_enabled", "true"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "sync_tag", "sync-123"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "two_stage_dial_type", "regular"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "automatic_participants.#", "2"),
					resource.TestCheckTypeSetElemAttr("infinity_conference.tf-test-conference", "automatic_participants.*", "/api/admin/configuration/v1/automatic_participant/1/"),
					resource.TestCheckTypeSetElemAttr("infinity_conference.tf-test-conference", "automatic_participants.*", "/api/admin/configuration/v1/automatic_participant/2/"),
			...
			// Test 2: Update to min configuration, then delete
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_conference.tf-test-conference", "resource_id"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "name", "tf-test-conference"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "description", ""),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "service_type", "conference"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "pin", ""),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "guest_pin", ""),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "allow_guests", "false"),
					resource.TestCheckResourceAttr("infinity_conference.tf-test-conference", "tag", ""),
				),
			},
