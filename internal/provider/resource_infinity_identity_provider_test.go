		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "resource_id"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "uuid"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "name", "tf-test Identity Provider full"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url"),

					// Optional basic fields
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "description", "Full test Identity Provider with all fields"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "idp_type", "oidc"),

					// SAML specific fields
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "sso_url", "https://idp.example.com/sso"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "idp_entity_id", "https://idp.example.com/entity"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "idp_public_key"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "service_entity_id", "https://pexip.example.com/entity"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "service_public_key"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "service_private_key"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "signature_algorithm", "http://www.w3.org/2001/04/xmldsig-more#rsa-sha384"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "digest_algorithm", "http://www.w3.org/2001/04/xmldsig-more#sha384"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "display_name_attribute_name", "displayName"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "registration_alias_attribute_name", "userPrincipalName"),

					// Additional assertion consumer service URLs
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url2"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url3"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url4"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url5"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url6"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url7"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url8"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url9"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url10"),

					// Worker and popup settings
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "worker_fqdn_acs_urls", "true"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "disable_popup_flow", "true"),

					// OIDC specific fields
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_flow", "implicit"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_client_id", "test-client-id-12345"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_client_secret", "test-client-secret-67890"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_token_url", "https://idp.example.com/oauth2/token"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_user_info_url", "https://idp.example.com/oauth2/userinfo"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_jwks_url", "https://idp.example.com/.well-known/jwks.json"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_token_endpoint_auth_scheme", "client_secret_basic"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_token_signature_scheme", "hs256"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_display_name_claim_name", "full_name"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_registration_alias_claim_name", "preferred_username"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_additional_scopes", "profile email phone address"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_france_connect_required_eidas_level", "eidas3"),

					// Attributes
					resource.TestCheckTypeSetElemAttrPair("infinity_identity_provider.test", "attributes.*", "infinity_identity_provider_attribute.attr1", "id"),
					resource.TestCheckTypeSetElemAttrPair("infinity_identity_provider.test", "attributes.*", "infinity_identity_provider_attribute.attr2", "id"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "resource_id"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "uuid"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "name", "tf-test Identity Provider min"),
					resource.TestCheckResourceAttrSet("infinity_identity_provider.test", "assertion_consumer_service_url"),

					// Optional fields cleared - verify defaults
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "idp_type", "saml"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "sso_url", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "idp_entity_id", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "idp_public_key", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "service_entity_id", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "service_public_key", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "service_private_key", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "signature_algorithm", "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "digest_algorithm", "http://www.w3.org/2001/04/xmlenc#sha256"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "display_name_attribute_name", "NameId"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "registration_alias_attribute_name", "NameId"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url2", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url3", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url4", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url5", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url6", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url7", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url8", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url9", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "assertion_consumer_service_url10", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "worker_fqdn_acs_urls", "false"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "disable_popup_flow", "false"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_flow", "code"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_client_id", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_client_secret", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_token_url", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_user_info_url", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_jwks_url", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_token_endpoint_auth_scheme", "client_secret_post"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_token_signature_scheme", "rs256"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_display_name_claim_name", "name"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_registration_alias_claim_name", "sub"),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_additional_scopes", ""),
					resource.TestCheckResourceAttr("infinity_identity_provider.test", "oidc_france_connect_required_eidas_level", "disabled"),
				),
			},
			{
