		...
		Steps: []resource.TestStep{
			// Test 1: Create with full configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "id"),
					resource.TestCheckResourceAttrSet("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "resource_id"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "name", "tf-test-break-in-allow-list-address"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "description", "Full test configuration for break-in allow list address"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "address", "10.0.0.0"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "prefix", "16"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "allowlist_entry_type", "proxy"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "ignore_incorrect_aliases", "false"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "ignore_incorrect_pins", "false"),
				),
			},
			// Test 2: Update to min configuration, then delete
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "name", "tf-test-break-in-allow-list-address"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "description", "Full test configuration for break-in allow list address"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "address", "192.168.1.0"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "prefix", "24"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "allowlist_entry_type", "user"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "ignore_incorrect_aliases", "false"),
					resource.TestCheckResourceAttr("infinity_break_in_allow_list_address.tf-test-break-in-allow-list-address", "ignore_incorrect_pins", "false"),
				),
			},
