		...
		Steps: []resource.TestStep{
			// Step 1: Create with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_webapp_branding.webapp_branding-test", "uuid"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "name", "tf-test-webapp-branding"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "description", ""),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "webapp_type", "webapp2"),
					resource.TestCheckResourceAttrSet("infinity_webapp_branding.webapp_branding-test", "branding_file"),
					resource.TestCheckResourceAttrSet("infinity_webapp_branding.webapp_branding-test", "last_updated"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "is_default", "false"),
				),
			},
			// Step 2: Update to full config (webapp_type and branding_file force replacement)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_webapp_branding.webapp_branding-test", "uuid"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "name", "tf-test-webapp-branding-full"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "description", "tf-test webapp branding description"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "webapp_type", "webapp3"),
					resource.TestCheckResourceAttrSet("infinity_webapp_branding.webapp_branding-test", "branding_file"),
					resource.TestCheckResourceAttrSet("infinity_webapp_branding.webapp_branding-test", "last_updated"),
					resource.TestCheckResourceAttr("infinity_webapp_branding.webapp_branding-test", "is_default", "false"),
				),
