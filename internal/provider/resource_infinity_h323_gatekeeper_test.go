		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "id"),
					resource.TestCheckResourceAttrSet("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "resource_id"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "name", "tf-test-h323-gatekeeper"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "description", "tf-test H323 Gatekeeper Description"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "address", "192.168.1.100"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "port", "1720"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "resource_id"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "name", "tf-test-h323-gatekeeper"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "description", ""),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "address", "192.168.1.101"),
					resource.TestCheckResourceAttr("infinity_h323_gatekeeper.tf-test-h323-gatekeeper", "port", "1719"),
				),
			},
			{
				// Step 3: Destroy
