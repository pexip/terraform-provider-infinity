		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_sip_proxy.sip-proxy-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_sip_proxy.sip-proxy-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "name", "tf-test-sip-proxy-full"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "description", "Full configuration test SIP proxy"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "address", "sip.pexvclab.com"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "port", "5061"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "transport", "tls"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_sip_proxy.sip-proxy-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_sip_proxy.sip-proxy-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "name", "tf-test-sip-proxy-min"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "description", ""),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "address", "sip.pexvclab.com"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "port", "5061"),
					resource.TestCheckResourceAttr("infinity_sip_proxy.sip-proxy-test", "transport", "tls"),
				),
