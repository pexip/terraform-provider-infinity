		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "name", "tf-test mjx-endpoint full"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "description", "Test MJX endpoint description"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "endpoint_type", "CISCO"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "room_resource_email", "room2@example.com"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "api_address", "192.168.1.101"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "api_port", "443"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "api_username", "apiuser"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "api_password", "apipassword"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "use_https", "YES"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "verify_cert", "YES"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "poly_username", "polyuser"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "poly_password", "polypassword"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "poly_raise_alarms_for_this_endpoint", "false"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "webex_device_id", "device-123"),
				),
			},
			// Step 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint.test", "id"),
					resource.TestCheckResourceAttrSet("infinity_mjx_endpoint.test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "name", "tf-test mjx-endpoint min"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "description", ""),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "endpoint_type", "CISCO"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "room_resource_email", "room@example.com"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "api_address", "192.168.1.100"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "use_https", "GLOBAL"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "verify_cert", "GLOBAL"),
					resource.TestCheckResourceAttr("infinity_mjx_endpoint.test", "poly_raise_alarms_for_this_endpoint", "true"),
					resource.TestCheckNoResourceAttr("infinity_mjx_endpoint.test", "api_port"),
					resource.TestCheckNoResourceAttr("infinity_mjx_endpoint.test", "api_username"),
					resource.TestCheckNoResourceAttr("infinity_mjx_endpoint.test", "poly_username"),
					resource.TestCheckNoResourceAttr("infinity_mjx_endpoint.test", "webex_device_id"),
				),
			},
			// Step 3: Destroy
			{
