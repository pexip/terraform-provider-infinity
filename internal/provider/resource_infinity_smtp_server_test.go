		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_smtp_server.smtp_server-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_smtp_server.smtp_server-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "name", "tf-test SMTP Server full"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "description", "full Test SMTPServer"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "address", "updated-server.example.com"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "port", "465"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "username", "smtp_server-test"),
					resource.TestCheckResourceAttrSet("infinity_smtp_server.smtp_server-test", "password"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "from_email_address", "updated@example.com"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "connection_security", "STARTTLS"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_smtp_server.smtp_server-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_smtp_server.smtp_server-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "name", "tf-test SMTP Server min"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "address", "test-server.example.com"),
					resource.TestCheckResourceAttr("infinity_smtp_server.smtp_server-test", "from_email_address", "test@example.com"),
				),
			},
			{
				// Step 3: Destroy
