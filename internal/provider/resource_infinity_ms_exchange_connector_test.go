...
func testInfinityMsExchangeConnector(t *testing.T, client InfinityClient) {
	...
	fullChecks := resource.ComposeTestCheckFunc(
		...
		resource.TestCheckResourceAttr("infinity_ms_exchange_connector.tf-test-ms-exchange-connector", "uuid", "test-uuid"),
	...
	minChecks := resource.ComposeTestCheckFunc(
		...
		resource.TestCheckResourceAttr("infinity_ms_exchange_connector.tf-test-ms-exchange-connector", "enable_dynamic_vmrs", "false"),
		resource.TestCheckResourceAttr("infinity_ms_exchange_connector.tf-test-ms-exchange-connector", "enable_personal_vmrs", "true"),
		resource.TestCheckResourceAttr("infinity_ms_exchange_connector.tf-test-ms-exchange-connector", "personal_vmr_oauth_auth_endpoint", "https://tf-test.example.com/personal/oauth/auth"),
		resource.TestCheckResourceAttr("infinity_ms_exchange_connector.tf-test-ms-exchange-connector", "personal_vmr_oauth_token_endpoint", "https://tf-test.example.com/personal/oauth/token"),
		resource.TestCheckResourceAttr("infinity_ms_exchange_connector.tf-test-ms-exchange-connector", "personal_vmr_adfs_relying_party_trust_identifier", "https://tf-test.example.com/adfs"),
