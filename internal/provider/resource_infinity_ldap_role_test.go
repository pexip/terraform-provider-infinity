		...
		Steps: []resource.TestStep{
			// Test 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ldap_role.ldap_role-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_ldap_role.ldap_role-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ldap_role.ldap_role-test", "name", "tf-test full"),
					resource.TestCheckResourceAttr("infinity_ldap_role.ldap_role-test", "ldap_group_dn", "testfull"),
					resource.TestCheckResourceAttr("infinity_ldap_role.ldap_role-test", "roles.#", "2"),
					resource.TestCheckTypeSetElemAttrPair("infinity_ldap_role.ldap_role-test", "roles.*", "infinity_role.test1", "id"),
					resource.TestCheckTypeSetElemAttrPair("infinity_ldap_role.ldap_role-test", "roles.*", "infinity_role.test2", "id"),
				),
			},
			// Test 2: Update with min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ldap_role.ldap_role-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_ldap_role.ldap_role-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ldap_role.ldap_role-test", "name", "tf-test min"),
					resource.TestCheckResourceAttr("infinity_ldap_role.ldap_role-test", "ldap_group_dn", "testmin"),
					resource.TestCheckResourceAttr("infinity_ldap_role.ldap_role-test", "roles.#", "0"),
				),
			},
