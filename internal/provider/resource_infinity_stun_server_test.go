		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_stun_server.tf-test-stun-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_stun_server.tf-test-stun-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "name", "tf-test-stun-server-full"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "description", "tf-test STUN server description"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "address", "stun-full.example.com"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "port", "5349"),
				),
			},
			// Step 2: Update to min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_stun_server.tf-test-stun-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_stun_server.tf-test-stun-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "name", "tf-test-stun-server"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "description", ""),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "address", "stun.example.com"),
					resource.TestCheckResourceAttr("infinity_stun_server.tf-test-stun-server", "port", "3478"),
				),
			},
			// Step 3: Destroy
			{
