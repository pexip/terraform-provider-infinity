		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_webapp_alias.tf-test-webapp-alias", "id"),
					resource.TestCheckResourceAttrSet("infinity_webapp_alias.tf-test-webapp-alias", "resource_id"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "slug", "tf-test-alias-full"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "description", "tf-test webapp alias description"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "webapp_type", "webapp3"),
					resource.TestCheckResourceAttrSet("infinity_webapp_alias.tf-test-webapp-alias", "is_default"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "is_enabled", "true"),
				),
			},
			// Step 2: Update to min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_webapp_alias.tf-test-webapp-alias", "id"),
					resource.TestCheckResourceAttrSet("infinity_webapp_alias.tf-test-webapp-alias", "resource_id"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "slug", "tf-test-alias"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "description", ""),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "webapp_type", "webapp2"),
					resource.TestCheckResourceAttrSet("infinity_webapp_alias.tf-test-webapp-alias", "is_default"),
					resource.TestCheckResourceAttr("infinity_webapp_alias.tf-test-webapp-alias", "is_enabled", "false"),
				),
			},
			// Step 3: Destroy
			{
