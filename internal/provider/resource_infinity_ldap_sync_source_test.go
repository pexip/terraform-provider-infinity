		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_source.ldap_sync_source-test", "id"),
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_source.ldap_sync_source-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "name", "ldap_sync_source-test"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "description", "Test LdapSyncSource"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "ldap_bind_username", "ldap_sync_source-test"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "ldap_use_global_catalog", "true"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "ldap_permit_no_tls", "true"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_ldap_sync_source.ldap_sync_source-test", "resource_id"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "name", "ldap_sync_source-test"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "description", "Updated Test LdapSyncSource"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "ldap_bind_username", "ldap_sync_source-test"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "ldap_use_global_catalog", "false"),
					resource.TestCheckResourceAttr("infinity_ldap_sync_source.ldap_sync_source-test", "ldap_permit_no_tls", "false"),
				),
			},
		},
	})
