		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_event_sink.tf-test-event-sink", "id"),
					resource.TestCheckResourceAttrSet("infinity_event_sink.tf-test-event-sink", "resource_id"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "name", "tf-test-event-sink"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "description", "tf-test Event Sink Description"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "url", "https://tf-test-webhook.example.com/events"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "username", "tf-test-user"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "password", "tf-test-password"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "bulk_support", "true"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "verify_tls_certificate", "true"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "version", "2"),
				),
			},
			{
				// Step 2: Update to min config (clear all optional fields)
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("infinity_event_sink.tf-test-event-sink", "resource_id"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "name", "tf-test-event-sink"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "description", ""),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "url", "https://tf-test-webhook.example.com/events"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "username", ""),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "password", ""),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "bulk_support", "false"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "verify_tls_certificate", "false"),
					resource.TestCheckResourceAttr("infinity_event_sink.tf-test-event-sink", "version", "1"),
				),
			},
			{
				// Step 3: Destroy
