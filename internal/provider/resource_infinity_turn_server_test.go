		...
		Steps: []resource.TestStep{
			// Step 1: Create with full config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_turn_server.tf-test-turn-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_turn_server.tf-test-turn-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "name", "tf-test-turn-server-full"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "description", "tf-test TURN server description"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "address", "turn-full.example.com"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "port", "5349"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "server_type", "coturn_shared"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "transport_type", "tls"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "username", "tf-test-username"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "password", "tf-test-password"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "secret_key", "tf-test-secret-key"),
				),
			},
			// Step 2: Update to min config
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("infinity_turn_server.tf-test-turn-server", "id"),
					resource.TestCheckResourceAttrSet("infinity_turn_server.tf-test-turn-server", "resource_id"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "name", "tf-test-turn-server"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "description", ""),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "address", "turn.example.com"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "port", "3478"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "server_type", "namepsw"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "transport_type", "udp"),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "username", ""),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "password", ""),
					resource.TestCheckResourceAttr("infinity_turn_server.tf-test-turn-server", "secret_key", ""),
				),
			},
			// Step 3: Destroy
			{
