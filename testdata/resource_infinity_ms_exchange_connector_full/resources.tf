...
resource "pexip_infinity_ms_exchange_connector" "tf-test-ms-exchange-connector" {
  ...
  oauth_certificate                                = "test-certificate"
  oauth_private_key                                = "test-private-key"
  oauth_client_secret                              = "test-value"
  oauth_token_endpoint                             = "test-value"
  graph_api_domain                                 = "test-graph.microsoft.com"
  graph_authentication_method                      = "APP_PERM_PK"
  ...
  personal_vmr_idp                                 = "test-personal-vmr-idp"
