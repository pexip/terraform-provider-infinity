...
- `id` (String) [CRC-32](https://pkg.go.dev/hash/crc32) checksum of `rendered` Pexip Infinity bootstrap config.
- `management_node_config` (String) Rendered Pexip Infinity Manager management node bootstrap configuration.
- `rendered` (String) Rendered Pexip Infinity Manager bootstrap configuration.
