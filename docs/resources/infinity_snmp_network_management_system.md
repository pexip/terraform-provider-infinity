...
- `name` (String) The name of the SNMP network management system. Maximum length: 250 characters.

### Optional

- `description` (String) Description of the SNMP network management system. Maximum length: 500 characters.
- `port` (Number) The port number for SNMP communications. Valid range: 1-65535.
- `snmp_trap_community` (String, Sensitive) The SNMP trap community name. Maximum length: 16 characters.
