...
- `address` (String) The IP address to be used in conjunction with the Network prefix to determine the network that this route applies to.
...
- `prefix` (Number) The prefix length used in conjunction with the Destination network address to determine the network that this route applies to. Range: 0 to 32.
