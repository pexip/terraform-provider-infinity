...
Manages an LDAP synchronization source configuration.
...
- `id` (String) Resource URI for the LDAP sync source
- `resource_id` (Number) The resource integer identifier for the LDAP sync source
