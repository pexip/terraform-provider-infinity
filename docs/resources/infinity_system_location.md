---
page_title: "infinity_system_location Resource - terraform-provider-pexip"
subcategory: ""
description: |-
  Manages a Pexip Infinity system location configuration.
---

# infinity_system_location (Resource)
...
```shell
terraform import infinity_system_location.example 123
```
