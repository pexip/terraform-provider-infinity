...
- `password` (String, Sensitive) The password used when accessing the proxy server. Maximum length: 100 characters.
- `port` (Number) The IP port of the proxy server. Range: 1 to 65535. Default: 8080.
- `protocol` (String) The protocol used to connect to the proxy server. Valid choices: http.
