...
page_title: "infinity_mjx_graph_deployment Resource - terraform-provider-pexip"
subcategory: ""
description: |-
...
# infinity_mjx_graph_deployment (Resource)

Manages an MJX Graph deployment. An MJX Graph deployment provides integration with the Microsoft Graph API, enabling OTJ (One-Touch Join) functionality for Microsoft 365 calendar-based meeting management.
