...
page_title: "infinity_mjx_meeting_processing_rule Resource - terraform-provider-pexip"
subcategory: ""
description: |-
...
# infinity_mjx_meeting_processing_rule (Resource)

Manages an MJX meeting processing rule. Meeting processing rules define how OTJ (One-Touch Join) extracts the meeting alias from calendar invitations based on meeting type and pattern matching.
