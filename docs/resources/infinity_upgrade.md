...
- `package` (String) Specific upgrade package to use. If not specified, the system will use the default upgrade package.

### Read-Only

- `id` (String) Unique identifier for this upgrade trigger
- `timestamp` (String) Timestamp when the upgrade was triggered
