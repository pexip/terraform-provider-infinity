...
- `certificate` (String) The PEM-encoded certificate. This field is sensitive.
- `private_key` (String, Sensitive) The PEM-encoded private key. This field is sensitive.

### Optional

- `parameters` (String) Additional parameters for the certificate. Maximum length: 1000 characters.
- `private_key_passphrase` (String, Sensitive) The passphrase for the private key if it is encrypted. This field is sensitive. Maximum length: 100 characters.
