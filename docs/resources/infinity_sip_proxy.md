...
- `port` (Number) The IP port of the SIP proxy. Range: 1 to 65535. Default: 5061.
- `transport` (String) The IP transport used to connect to the SIP proxy. Valid choices: udp, tcp, tls.
